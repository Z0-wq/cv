...
## 当前推进
- 阶段：阶段六 综合项目与部署
- 知识点：7.1 摄像头实时推理集成（讲解中）

## 待办
- 7.1摄像头实时推理 → 7.2嵌入式部署(可选) → 7.3项目文档化GitHub整理
- **阶段六完成后**：在roadmap.md新增"进阶"阶段，补充高阶内容（用户已确认：先完成阶段六再加深度，方向待用户后续说明，如ViT/注意力机制/检测架构进阶/论文/部署优化等方向可选）
